...
public class longsentence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        education_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this,Education.class);
        ...
        mypage_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this,Mypage.class);
                startActivity(intent);
            }
        });
        // 학습메뉴에서 셋팅 눌렀을 시
        setting_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this,Setting.class);
                startActivity(intent);
            }
        });
        //집 눌렀을때
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this, educationpage_home1.class);
                startActivity(intent);
            }
        });
        //학교 눌렀을때
        school.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this, educationpage_school2.class);
                startActivity(intent);
            }
        });
        //쇼핑 눌렀을때
        shopping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this, educationpage_shopping3.class);
                startActivity(intent);
            }
        });
        //병원 눌렀을때
        hos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(longsentence.this, educationpage_hos4.class);
                startActivity(intent);
            }
        });
    }
